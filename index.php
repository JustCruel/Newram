...
<body>
    ...
    <div class="modal" id="register-modal">
        <div class="modal-content">
            ...
            <div class="modal-buttons">
                ...
                <a href="userregister.php" class="register-link">Go to Registration</a>
            </div>
        </div>
    </div>
    ...
    <section class="scrollable">
        <div class="scrollable-item">
            <img src="images/discounts.jpg" alt="Feature 1">
            <h3>Affordable Fares</h3>
            <p>Enjoy discounts on your trips.</p>
        </div>
        <div class="scrollable-item">
            <img src="images/bus1.jpg" alt="Feature 2">
            <h3>Comfortable Buses</h3>
            <p>Ride in style and comfort.</p>
        </div>
        <div class="scrollable-item">
            <img src="images/route.jpg" alt="Feature 3">
            <h3>Convenient Routes</h3>
            <p>Track easily.</p>
        </div>
        <div class="scrollable-item">
            <img src="images/cashback.jpg" alt="Feature 1">
