        ...
        <ul class="list-unstyled components mb-5">
            ...
            <ul class="list-unstyled components mb-5">
                <?php if ($role === 'Superadmin') { ?>
                    <ul class="list-unstyled components mb-5">
                        <li class="active">
                            <a href="./admin/admindashboard.php"><span class="fa fa-home"></span>
                                Dashboard</a>
                        </li>
                        <li>
                            <a href="./admin/register.php"><span class="fa fa-user"></span>
                                Registration</a>
                        </li>
                        <li>
                            <a href="./admin/activate.php"><span class="fa fa-sticky-note"></span>
                                Activation</a>
                        </li>
                        <li>
                            <a href="./admin/deactivate.php"><span class="fa fa-sticky-note"></span>
                                Deactivation</a>
                        </li>

                        <li>
                            <a href="./admin/revenue.php"><span class="fa fa-cogs"></span>
                                Revenue</a>
                        </li>
                        <li>
                            <a href="./admin/fareupdate.php" onclick=""><span class="fa fa-arrow-up-1-9"></span>
                                Fare Update</a>
                        </li>
                        <li>
                            <a href="./admin/businfo.php">
                                <span class="fa fa-bus"></span> Reg Bus Info
                            </a>
                        </li>
                        <li>
                            <a href="./admin/busviewinfo.php">
                                <span class="fa fa-eye"></span> View Bus Info
                            </a>
                        </li>
                    ...
                    <ul class="list-unstyled components mb-5">
                        <li class="active">
                            <a href="./cashier/cashierdashboard.php"><span class="fa fa-tachometer-alt"></span>
                                Dashboard</a>
                        </li>
                        <li>
                            <a href="./cashier/loadrfidadmin.php"><span class="fa fa-credit-card"></span>
                                Load RFID</a>
                        </li>
                        <!-- <li>
                        <a href="./activatecashier.php"><span class="fa fa-bolt"></span>
                        ...
                        <li>
                            <a href="./cashier/translogscashier.php"><span class="fa fa-list-alt"></span>
                                Load Transaction</a>
                        </li>
                        <li>
                            <a href="./cashier/loadtranscashier.php"><span class="fa fa-chart-line"></span>
                                Load Revenue</a>
                        </li>
                    ...
                    <ul class="list-unstyled components mb-5">
                        <li class="active">
                            <a href="./conductor/conductordashboard.php"><span class="fa fa-tachometer-alt"></span>
                                Dashboard</a>
                        </li>
                        <li>
                            <a href="./conductor/busfare.php"><span class="fa fa-bus"></span> Bus Fare</a>
                        </li>
                        <li>
                            <a href="./conductor/passengerlists.php"><span class="fa fa-users"></span> Passenger Lists</a>
                        </li>
                        <li>
                            <a href="./conductor/loadrfidconductor.php"><span class="fa fa-id-badge"></span> Load RFID</a>
                        </li>
                        <li>
                            <a href="./conductor/translogscon.php"><span class="fa fa-history"></span> Load Transaction</a>
                        </li>
                        <li>
                            <a href="./conductor/loadtranscon.php"><span class="fa fa-dollar-sign"></span> Load Revenue</a>
                        </li>
                        <li>
                            <a href="./conductor/remitcon.php"><span class="fa fa-paper-plane"></span> Remit</a>
                        </li>
