...
<body>
    <div class="sidebar">
        ...
        <a class="button-card" href="dashboardhome.php">
            <i class="fas fa-tachometer-alt"></i> Home
        </a>
        <a class="button-card" href="profile.php">
            <i class="fas fa-user"></i> My Profile
        </a>
        <a class="button-card" href="wallet.php">
            <i class="fas fa-wallet"></i> Wallet
        </a>

        <a class="button-card" href="change_pass.php">
            <i class="fas fa-wallet"></i> Change Password
        </a>
